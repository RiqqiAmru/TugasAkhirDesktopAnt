...
public final class MainMenu extends javax.swing.JFrame {
    ...
    public MainMenu(int idAkun) {
        ...
        PanelProfil profil = new PanelProfil(idAkun, crud, this);
    ...
    public void tampilJam() {
        ActionListener al = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Date tgl = new Date();
                SimpleDateFormat date = new SimpleDateFormat("EEEE, dd MMMM yyyy hh:mm:ss", new Locale("id", "ID"));
                date.format(tgl);
                lWaktu.setText(tgl.toString());
            }
        };
